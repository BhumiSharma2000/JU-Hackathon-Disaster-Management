...
<title>Funding for Disaster</title>
...
<div class="main">
    ...
    <div class="dv">
    <span><input type="hidden" id="key" name="key" placeholder="Merchant Key" value="fxRAWmI8" /></span>
    </div>
    
    <div class="dv">
    <span><input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="bMEQAFB7Re" /></span>
    </div>
    ...
    <div class="dv">
    <span class="text"><label>Name of Disaster:</label></span>
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Name of Disaster" value="" /></span>
    </div>
