          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
				...
				<?php
					$query="SELECT tb1_login.email_id,tb1_login.login_id,tb1_login.type,tb1_login.phone_no,tb1_detail.name,tb1_detail.profile_pic FROM tb1_login INNER JOIN tb1_detail ON tb1_login.login_id=tb1_detail.login_id WHERE(tb1_detail.login_id != '$id' AND tb1_login.type=2) AND tb1_login.active=1";;
