  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Current-Disaster</li>
      </ol>
      <?php
        if(isset($_GET['flag'])){
        if($_GET['flag']==1)
          {
                echo "<center><font style='color:green; text-align:center;font-size:18px'><b><u><i>Current-Disaster Added Successfully</i></u></b></font></center><br/>";           }
        }
      ?>  
    </section>
    <!-- Main content -->
    <section class="content">
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="insertcurrentdisaster.php" enctype="multipart/form-data" >
                <!-- text input -->
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="description" placeholder="Enter Description of Current disaster..." required></textarea>
                </div>
				<div class="form-group">
