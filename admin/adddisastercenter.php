  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Disaster-Centers</li>
      </ol>
        <?php
        if(isset($_GET['flag'])){
        if($_GET['flag']==1)
          {
            echo "<center><font style='color:green; text-align:center;font-size:18px'><b><u><i>Disaster-Centers Added Successfully</i></u></b></font></center><br/>";           
            }
        }
      ?>  
    </section>
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="insertdisastercenter.php" enctype="multipart/form-data" >
                <!-- text input -->
