            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
				  ...
				  <td> 
				  <a class="btn btn-success btn-xs" href="editlatestdisaster.php?id=<?php echo $value2['disaster_id'];?> " 
					onclick="return confirm('Sure to Edit ?');">Edit</a> &nbsp;&nbsp;
                    </td>
                    <td>
				  <a class="btn btn-danger btn-xs" href="deletelatestdisaster.php?del=<?php echo $value2['disaster_id'];?>" 
