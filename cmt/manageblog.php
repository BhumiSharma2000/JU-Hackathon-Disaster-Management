          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
				...
				<?php
					$query="SELECT * FROM tb1_blog WHERE status='1' AND verified='0'";
                ...
                <tr>
				  ...
				  <td> 
				  <a class="btn btn-success btn-xs" href="verifyblog.php?id=<?php echo $value2['blog_id'];?> " 
					onclick="return confirm('Sure to Verify ?');">Verified</a> &nbsp;&nbsp;
                    </td>
                    <td>
				  <a class="btn btn-danger btn-xs" href="deleteblog.php?del=<?php echo $value2['blog_id'];?>" 
