    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="managelostpeople.php"><i class="fa  fa-key"></i>Manage Lost Peoples</a></li>
            <li><a href="viewlostpeople.php"><i class="fa fa-eye"></i>View Lost Peoples</a></li>
              <li><a href="managefoundpeople.php"><i class="fa  fa-key"></i>Manage Found Peoples</a></li>
            <li><a href="viewfoundpeople.php"><i class="fa fa-eye"></i>View Found Peoples</a></li>
              <li><a href="viewrescuedpeople.php"><i class="fa fa-view"></i>View Rescued People</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="manageblog.php"><i class="fa  fa-key"></i>Manage Blogs</a></li>
            <li><a href="viewblog.php"><i class="fa fa-eye"></i>View Blog</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="managecurrentdisaster.php"><i class="fa  fa-key"></i>Manage Latest Disasters</a></li>
            <li><a href="viewcurrentdisaster.php"><i class="fa fa-eye"></i>View Latest Disasters</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="addnotification.php"><i class="fa  fa-plus"></i>Add Notifications</a></li>
            <li><a href="managenotification.php"><i class="fa  fa-key"></i>Manage Notifications</a></li>
            <li><a href="viewnotification.php"><i class="fa  fa-eye"></i>View Notifications</a></li>
          </ul>
        </li>
          <li class="treeview">
          <a href="#">
