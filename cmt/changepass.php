<?php
	...
	{
		$log = $_SESSION['log'];	
		$qry = "SELECT * FROM tb1_login WHERE email_id='$log'";
		$result = mysqli_query($con,$qry);
		$value = mysqli_fetch_array($result);
		$id = $value['login_id'];
		$pass = $value['password'];
		$sql = "SELECT * FROM tb1_detail WHERE login_id='$id'";
...
{	
    ...
    if($pass==$old_pass)
    {
        if($pass1==$pass2)	
        {
            $update = "UPDATE tb1_login SET password='$pass1' WHERE login_id='$id'";
    ...
    {
        echo "<center><font style='color:red; text-align:center;font-size:18px'><b><u><i>Incorrect Old Password</i></u></b></font></center><br/>";
    }
}
?> 	         
</form>
