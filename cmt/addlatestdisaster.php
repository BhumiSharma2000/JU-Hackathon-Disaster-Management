            ...
            <div class="box-body">
              <form role="form" method="POST" action="insertdisaster.php" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="description" placeholder="Enter Address..." required></textarea>
                </div>
				<div class="form-group">
                  ...
                  <input type="file" id="profile-img" name="image" accept="image/png,image/jpg,image/jpeg" class="form-control" placeholder="">
					<div id="myDiv" align="center"> 
						<!--<p class="square"> -->
					  <img src="photos/2.jpg" id="profile-img-tag" alt="Profile Pic" width="200px" height="200px" style="border:5px solid #ffffff; background-color: #ffffff;" />
