  ...
  <style>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add CMT-Members</li>
      </ol>
      <?php
        if(isset($_GET['flag'])){
        if($_GET['flag']==1)
          {
            echo "<center><font style='color:green; text-align:center;font-size:18px'><b><u><i>CMT-Members Added Successfully</i></u></b></font></center><br/>";
          }
        }
      ?>  
       <?php
    ...
    <section class="content">
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="insertcmt.php" enctype="multipart/form-data" >
                <!-- text input -->
				...
				<div class="form-group">
                  ...
                  <input type="password" pattern=.{8,12} title="Enter 8 to 12 characters" name="pass2" id="pass2" class="form-control" placeholder="Re-Enter Password ..." oninput="check(this)" required />
