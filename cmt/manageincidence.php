            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                <tr>
				  ...
				  <th>Occurred_Date</th>
                  <th>Occurred_Time</th>
                  <th>IncidenceImage</th>
                  <th>Verify</th>
                    <th>Delete</th>
                </tr>
				<?php
					$query="SELECT * FROM tb1_incidence WHERE status='1' AND verified='0'";
                ...
                <td><?php echo $q['name'];?></td>
				  ...
				  <td><?php echo $value2['occurred_date'];?></td>
                     <td><?php echo $value2['occurred_time'];?></td> 
                  <td><img src="<?php echo $value2['image']; ?>" height="50" width="50" border="1px" alt="profile pic"></td>
				  <td> 
				  <a class="btn btn-success btn-xs" href="verifyincidence.php?id=<?php echo $value2['incidence_id'];?> " 
					onclick="return confirm('Sure to Verify ?');">Verified</a> &nbsp;&nbsp;
                    </td>
                    <td>
				  <a class="btn btn-danger btn-xs" href="delete.php?del=<?php echo $value2['incidence_id'];?>" 
